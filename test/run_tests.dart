...
final String xcodeProjRelativePath =
    '/platforms/ios/$TEST_PROJECT_NAME.xcodeproj';
...
main() {
  ...
  createCordovaProject().then((exitCode) => addPlatforms().then((exitCode) =>
      addIBeaconPlugin().then((exitCode) => openInXCode().then((exitCode) {
...
Future<int> addIBeaconPlugin() {
  print('Adding the iBeacon plugin to the generated project...');
